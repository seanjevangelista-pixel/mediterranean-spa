  ...
  try {
    const r = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: ['mediterr20nean@gmail.com', 'seanjevangelista@gmail.com'],
        subject: `New Booking Inquiry — ${service}`,
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
            <div style="background:#7B5C3A;padding:28px 32px;border-radius:8px 8px 0 0">
              <h2 style="color:#fff;margin:0;font-size:20px">New Booking Inquiry</h2>
              <p style="color:rgba(255,255,255,0.65);margin:6px 0 0;font-size:14px">Mediterranean Massage and Esthetics</p>
            </div>
